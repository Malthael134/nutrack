...
async function getAction(path) {
  ...
  let { server: actionLookup } = await import('../index_BOlrdqWF.mjs');
...
const route = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  POST
}, Symbol.toStringTag, { value: 'Module' }));

export { ApiContextStorage as A, callSafely as c, formContentTypes as f, getAction as g, hasContentType as h, route as r };
